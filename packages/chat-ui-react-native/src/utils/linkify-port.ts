...
const IP_ADDRESS_STRING =
  ...
  '|[1-9][0-9]|[0-9]))';
const TLD_CHAR = 'a-zA-Z' + UCS_CHAR;
...
const IRI_LABEL =
  ...
  LABEL_CHAR +
  ']){0,1}';
const STRICT_TLD = '(?:' + IANA_TOP_LEVEL_DOMAINS + '|' + PUNYCODE_TLD + ')';
const STRICT_HOST_NAME = '(?:(?:' + IRI_LABEL + '\\.)+' + STRICT_TLD + ')';
const STRICT_DOMAIN_NAME =
  '(?:' + STRICT_HOST_NAME + '|' + IP_ADDRESS_STRING + ')';
...
export const RICH_TEXT =
  '\n\n' +
  "Hán Trung Kiên https://en.wikipedia.org/wiki/Witold's_Report\n\n" +
  'Hán Trung Kiên google.vn\n\n' +
  'Hán Trung Kiên https://kien-google.han.me\n\n' +
  '@Hán Trung Kiên:69\n\n' +
  'https://google #PISCALE\n\n' +
  '[@Hán Trung Kiên:69]\n\n#PISCALE\n\n' +
  'email = kienhantrung@gmail.com\n\nphone = 0911667993\n\n' +
  'link = https://hántrungkiên.com.vn\n\n' +
  'link = https://www.example.ir/234_eds/index.htm\n\n' +
  'link = http://invalid.com/perl.cgi?key=\n\n' +
  'link = http://web-site.com/cgi-bin/perl.cgi?key1=value1&key2\n\n' +
  'link = http://www.example.com/products?id=1&page=2\n\n' +
  'link = http://www.example.com/#up\n\n' +
  'link = http://255.255.255.255\n\n' +
  'link = http://0911667993.vn\n\n' +
  'link = http://☺.damowmow.com/\n\n' +
  'link = http://उदाहरण.परीक्षा\n\n' +
  'link = http://例子.测试\n\n' +
  'link = http://مثال.إختبار\n\n' +
  'link = http://foo.com/blah_blah_(wikipedia)_(again)\n\n' +
  'link = http://userid:password@example.com:8080/\n\n' +
  'link = http://foo.com/unicode_(✪)_in_parens/\n\n' +
  'link = http://code.google.com/events/#&product=browser\n\n' +
  'link = https://exemple.com/is/image/file/3221614006821_h_f_l_0?wid=1000&hei=1000\n\n' +
  'link = https://www.google-analytics.com/(.*)&ec=click(.*)\n\n' +
  'link = http://hantrungkien.vn/\n\n' +
  'link = http://hantrungkien.vn/ \n\n' +
  'link = https://www.example.com/foo/?bar=baz&inga=42&quux';

// new RegExp(WEB_URL,'gim').exec(RICH_TEXT)
// new RegExp(WEB_URL,'gim').exec("https://kien-google.han.me")
// new RegExp(WEB_URL,'gim').exec("kienhantrung@gmail.comn")
