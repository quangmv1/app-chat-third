...
import {
  PSIcFileCommon24 as CSV,
  PSIcFileCommon24 as GenericFile,
  PSIcFileCommon24 as HTML,
  PSIcFileCommon24 as MD,
  PSIcFileCommon24 as ODT,
  PSIcFileCommon24 as RTF,
  PSIcFileCommon24 as SEVEN_Z,
  PSIcFileTxt24 as TXT,
  PSIcFileCompress24 as RAR,
  PSIcFileCompress24 as TAR,
  PSIcFileCompress24 as ZIP,
  PSIcFileXls24 as XLS,
  PSIcFileXls24 as XLSX,
  PSIcFilePdf24 as PDF,
  PSIcFilePpt24 as PPT,
  PSIcFilePpt24 as PPTX,
  PSIcFileDoc24 as DOC,
  PSIcFileDoc24 as DOCX,
  PSIcFileAudio24 as Audio,
  PSIcFileVideo24 as Video,
  PSIcFileImage24 as Image,
  IconProps,
} from '../icons';
...
for (const type of imageFileTypes) {
  mimeTypeToIconMap[type] = Image;
}

export const mimeTypeToIcon = (mimeType?: string | null) => {
  if (!mimeType) {
    return GenericFile;
  }
